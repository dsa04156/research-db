...
canonical_key: "arxiv:2608.05792"
...
[원문 열기](https://arxiv.org/abs/2608.05792)
...
- 수집 채널: `openalex`
- 검토 상태: `pending`
- Zotero: created (`DCK56HTG`)
- 발행일: 2026-08-06
- 저자: Kai Li, Conggai Li, Sarah Siddiqui, Syed Ishtiaque Ahmed, Xin Yuan, Shenghong Li, Wei Ni
- 식별자: `arxiv:2608.05792`

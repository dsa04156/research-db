...
- 웹 트렌드: Codex가 최근 7일 원문과 날짜를 확인해 보강 수집
...
주간 자동화는 일요일마다 `vault/Synthesis/YYYY-Www.md`에 합의점, 충돌,
...
3. 설정된 트렌드 질의로 최근 7일 웹 자료를 보강합니다.
4. 한국어 일일 브리핑과 시드 글과의 연결 분석을 작성합니다.
